...
| Insularidad / falta de coordinación interna | FODA: debilidad explícita; ítem 16 "no existen insularidades": 3,2/5 (en desacuerdo parcial) | 1 Dirección Nacional (7 departamentos + 5 unidades asesoras) + 16 Direcciones Regionales, cada una con su propio stock de procedimientos |
...
### 2.4 La prueba de que sí se puede: fiscalizador versus administrador

No todo en esta comparación es estancamiento. El propio Diagrama Sistémico de 2012 nombraba, como una de las "Deficiencias de Nivel Estratégico", la tensión **"Fiscalizador v/s Administrador"**: JUNJI concentraba a la vez la administración directa de jardines infantiles y la fiscalización de esos mismos jardines (propios y de terceros), un conflicto de interés estructural que la encuesta de 2012 nunca alcanzó a resolver.

En julio de 2025 —trece años después— la **Ley de Modernización de Educación Parvularia** finalmente resolvió exactamente ese punto: le retiró a JUNJI la facultad de supervigilancia y fiscalización de jardines infantiles, "eliminando el conflicto de interés que generaba el concentrar facultades de provisión y fiscalización en un solo organismo", y trasladó esa función a la Superintendencia de Educación, que crea para ello una **Intendencia de Educación Parvularia**. JUNJI deja de fiscalizar y debe reconstruir su rol de calidad como **contraparte técnica** de ese nuevo organismo externo, no como su fiscalizador interno.

La lección para este proyecto es directa: los problemas estructurales de JUNJI **sí se resuelven**, pero solo cuando la intervención opera al nivel correcto —la ley, la arquitectura, el diseño institucional— y no al nivel de la buena voluntad de una administración particular. Es el mismo argumento que sostiene la Política Institucional de IA: no basta con que cada Vicepresidencia decida usar mejor los datos o simplificar procedimientos: hay que resolverlo con el mismo tipo de intervención estructural que finalmente destrabó "fiscalizador versus administrador" en 2025.

Fuente: [Presidente promulga Ley de Modernización de Educación Parvularia — JUNJI](https://junji.cl/presidente-gabriel-boric-encabeza-promulgacion-de-la-ley-de-modernizacion-de-educacion-parvularia/), [Las claves de la nueva Ley de Modernización de Educación Parvularia — CNN Chile](https://www.cnnchile.com/pais/detalles-nueva-ley-modernizacion-educacion-parvularia_20250715/)
...
JUNJI no es una organización simple, es un **sistema sociotécnico complejo**: miles de nodos semiautónomos (2.926+ establecimientos, 16 Direcciones Regionales —una por cada región del país, incluida la Metropolitana— más la Dirección Nacional con sus 7 departamentos de línea y 5 unidades asesoras) que interactúan mediante canales de información débilmente acoplados. La Dirección Nacional no es una región más: es el nivel central del que dependen jerárquicamente las 16 regionales, y esa relación central-regional es, junto con la de departamento a departamento, la otra costura donde el diagnóstico encuentra fricción. La "insularidad" que tanto el diagnóstico de 2012 como el de 2026 identifican no es un problema de "cultura" o de mala voluntad — es lo esperable cuando un sistema tiene **alta modularidad** (cada departamento funciona como una unidad casi independiente, con su propio stock de procedimientos) pero **baja integración** (no existe un protocolo común de datos ni de decisiones entre esos módulos). Un sistema así puede funcionar razonablemente bien módulo por módulo, y aun así producir un comportamiento agregado disfuncional — que es exactamente lo que muestran ambos diagnósticos: cada área, vista aisladamente, tiene gente capaz y procesos documentados; el problema aparece en las costuras, entre departamentos, entre nivel central y regiones, entre lo que se promete y lo que se puede verificar.
...
Aplicado a JUNJI, esto se traduce en un diseño concreto para los agentes por proceso: en vez de una lista de chequeo binaria, el agente de Aseguramiento de la Calidad Educativa puede combinar variables —antigüedad del último acompañamiento técnico, alertas previas, matrícula, exposición a riesgo climático o de infraestructura, dotación de personal— cada una "difusa" (baja/media/alta), para producir una **prioridad de acompañamiento compuesta**, no una casilla de sí/no. Nótese que esto ya no es fiscalización —esa facultad la traspasó fuera de JUNJI la Ley de Modernización de Educación Parvularia de 2025 (sección 2.4)— sino el criterio con que JUNJI decide dónde reforzar su propio apoyo técnico-pedagógico y qué reportar como contraparte de la Superintendencia. Esto conecta directo con un hallazgo de 2012 (ítem 45: *"existe un mapa de riesgos… vinculado a los productos estratégicos"*, la evaluación más alta de toda la encuesta, 4,8/5) que nunca se tradujo en un mecanismo operativo de priorización — la IA es, catorce años después, la primera herramienta realista para cerrar esa brecha entre "sabemos identificar el riesgo" y "actuamos según ese riesgo de forma sistemática".

### 3.4 Funciones versus procesos: por qué JUNJI está organizada para administrarse a sí misma, no para atender de punta a punta

Toda organización tiene que resolver una tensión de diseño irreductible: agrupar a las personas **por función** (especialidad técnica: jurídica, financiera, de personas, informática) o **por proceso** (por el recorrido completo que sigue un caso real, de principio a fin, cruce lo que cruce). JUNJI —como casi todo el Estado chileno, y como casi toda organización grande que crece por acumulación histórica de resoluciones— eligió lo primero. La Resolución 429/2025 es, literalmente, un mapa de funciones: Planificación, Fiscalía y Asesoría Jurídica, Gestión y Desarrollo de Personas, Recursos Financieros, Comunicaciones y Ciudadanía, Calidad Educativa, Cobertura y Habilitación de Espacios Educativos. Ninguno de esos nombres describe algo que le pase a un niño, a una familia o a un jardín infantil de principio a fin — describen una disciplina administrativa.

La organización funcional tiene ventajas reales y por eso es la opción por defecto: concentra la pericia técnica (un solo lugar donde se acumula el conocimiento jurídico, financiero, de datos), es más fácil de auditar contra normas especializadas (Contraloría revisa Fiscalía; DIPRES revisa Recursos Financieros), y da líneas de mando claras. Su costo, ya documentado dos veces con 14 años de distancia (2012 y 2026), es que **casi ningún caso real vive dentro de una sola función**: asegurar la calidad de un jardín cruza Calidad Educativa, Cobertura y la Dirección Regional —además de la Superintendencia de Educación, externamente—; una respuesta a un oficio parlamentario cruza Gabinete, Fiscalía, Planificación y Comunicaciones. Cada cruce entre funciones es una costura, y las costuras son exactamente donde el diagnóstico —en ambas décadas— encuentra la insularidad, la demora y los datos que no concilian. Esto no es una falla de ejecución de las personas: es la consecuencia predecible de diseñar la organización alrededor de la especialidad en vez de alrededor del resultado para el usuario. La literatura de rediseño organizacional (la reingeniería de procesos de negocio, popularizada por Hammer y Champy desde los años noventa, y el "modelo de estrella" de Galbraith sobre estructura organizacional) documenta este mismo patrón en organizaciones de todo tipo: crecer por función optimiza cada pieza y desoptimiza el conjunto.

JUNJI ya intuyó parte de esto: la propia Resolución 429 crea, dentro del Departamento de Planificación, una **Oficina de Gestión de Procesos**, con el mandato explícito de "liderar y coordinar el levantamiento y rediseño de los procesos críticos". Es un buen síntoma —la institución sabe que el problema existe— pero es también el ejemplo perfecto de la limitación: se resuelve un problema de **proceso** (algo que cruza toda la institución) creando una nueva **función** (una oficina más, dentro de un departamento más, con su propia jefatura). Esa oficina puede levantar y documentar procesos, pero no tiene autoridad formal sobre el presupuesto, la dotación o las prioridades de Fiscalía, Cobertura o Calidad Educativa — puede recomendar, no puede ordenar. Es el problema clásico de la "organización matricial" sin resolver: alguien es responsable del proceso de punta a punta, pero nadie que reporte a esa persona.

### 3.5 Caso aplicado: la evaluación ex ante y la Oficina de Oferta Programática Institucional

Este patrón no es abstracto — tiene un ejemplo concreto, actual y bien documentado en la propia REX N°408/2026 (la modificación más reciente a la orgánica). Todo programa social del Estado, para mantenerse o ampliarse dentro de la Ley de Presupuestos, debe pasar por una **evaluación ex ante**: un proceso técnico, conducido por la Subsecretaría de Evaluación Social del Ministerio de Desarrollo Social y Familia (MDSyF) en conjunto con la Dirección de Presupuestos (DIPRES), que revisa la pertinencia, el diseño, la focalización y la coherencia de cada programa con la oferta pública existente antes de aprobar su financiamiento. Es, por definición, un proceso de punta a punta: necesita datos de cobertura y matrícula (Departamento de Cobertura), indicadores de calidad (Calidad Educativa), cifras de ejecución presupuestaria (Recursos Financieros) y una narrativa técnica coherente (Planificación) — los cuatro a la vez, reconciliados, en el mismo expediente.

El diagnóstico de 2012 ya marcaba esta costura como débil, con nombre y apellido: el **Formulario H** (el instrumento de DIPRES que identifica y da seguimiento a cada programa público en el ciclo presupuestario) aparece dos veces en la encuesta de 2012, y aunque los directivos entendían razonablemente bien sus indicadores (ítem 5: 4,3/5) y su difusión interna (ítem 15: 4,0/5), el "Control de gestión" agregado —si esos indicadores realmente eran claros, fidedignos y usados para decidir— cayó a 3,0/5, el segundo puntaje más bajo de toda la encuesta. Es decir: JUNJI sabía leer el formulario, pero el sistema detrás de él no producía información confiable para tomar decisiones. Catorce años después, la propia REX N°408/2026 reconoce el mismo vacío y responde creando la **Oficina de Oferta Programática Institucional** (dentro de la Sección de Gestión Estratégica del Departamento de Planificación), cuyas funciones explícitas incluyen "generar diálogo técnico con las instituciones del nivel, Subsecretaría de Evaluación Social (MDSyF) y Dirección de Presupuestos en materias programáticas" y "liderar el monitoreo de la oferta programática en articulación con los otros departamentos".

Leído con el marco de las secciones 3.1-3.4, esta nueva Oficina es exactamente el mismo patrón: una respuesta funcional (una oficina más) a un problema de proceso (evaluación ex ante, que por su propia naturaleza legal cruza cuatro departamentos y dos instituciones externas). Es un paso necesario y correcto —alguien tiene que ser el punto de contacto formal con MDSyF y DIPRES— pero no resuelve por sí solo la reconciliación de datos entre Cobertura, Calidad Educativa y Recursos Financieros que la evaluación ex ante exige. Ahí es donde un **agente de Oferta Programática / Evaluación Ex Ante** —sumado a la lista de agentes candidatos de la sección 3.3 de `estrategia-ia-junji-2026.md`— tiene un caso de uso inmediato y de alto valor: reunir automáticamente los datos de cobertura, indicadores de calidad y ejecución presupuestaria que hoy se concilian a mano entre departamentos; mantener memoria institucional de qué observó MDSyF o DIPRES en ciclos anteriores para no repetir los mismos errores; y dejar trazabilidad de dónde viene cada cifra que finalmente se envía —el antídoto directo, catorce años después, al "Control de gestión: 3,0/5" de 2012.

### 3.6 De la cadena de valor (2012) a los agentes por proceso (2026): la reestructuración real

El documento de 2012 ya modelaba a JUNJI como una **cadena de valor end-to-end**: entregar educación parvularia (directa e indirecta), gestionar jardines, financiar construcción/habilitación, asegurar y certificar calidad, fiscalizar, supervisar, administrar personas, administrar TICs. (La fiscalización de jardines infantiles ya no es función de JUNJI desde la Ley de Modernización de Educación Parvularia de 2025 — sección 2.4; el resto de la cadena de valor de 2012 sigue vigente.) Esa mirada por proceso nunca se tradujo en la estructura formal de la institución — la Resolución 429/2025, trece años después, sigue organizando JUNJI por **departamento**, no por **proceso end-to-end**, con la evaluación ex ante (sección 3.5) como el ejemplo más reciente y concreto de esa brecha.

Esta es la reestructuración de fondo que la IA hace posible sin tener que rehacer de inmediato toda la orgánica: los agentes de la arquitectura "cerebro-pulpo" se diseñan **desde el día uno alineados a los procesos de la cadena de valor** (aseguramiento de calidad end-to-end, cobertura end-to-end, evaluación ex ante end-to-end) — no calcados al organigrama de la REX 429 —, cada uno cruzando varios departamentos a propósito, con el núcleo MCP como el punto donde esos procesos se coordinan aunque las personas sigan reportando a jefaturas distintas (ver el detalle por proceso en `estrategia-ia-junji-2026.md`, sección 3.3). Es, en la práctica, empezar a operar como una **institución basada en procesos** usando la IA como el mecanismo de coordinación —el "dueño de proceso" que la organización matricial necesita y que hoy no tiene autoridad formal para serlo— antes de que sea necesario (o posible, políticamente) reescribir la Resolución 429 desde cero.
...
- **Organización funcional vs. por procesos:** agrupar a las personas por especialidad técnica (función) versus agruparlas alrededor del recorrido completo de un caso real de principio a fin (proceso). La mayoría de los problemas de coordinación de JUNJI ocurren en las costuras entre funciones, no dentro de ellas.
- **Evaluación ex ante:** revisión técnica previa, a cargo de la Subsecretaría de Evaluación Social (MDSyF) y DIPRES, que valida el diseño, la focalización y la coherencia de un programa social antes de aprobar o mantener su financiamiento en la Ley de Presupuestos.
- **Formulario H:** instrumento de DIPRES para identificar y dar seguimiento presupuestario a cada programa público; mencionado explícitamente en la encuesta interna de JUNJI de 2012 como un punto débil de control de gestión.
